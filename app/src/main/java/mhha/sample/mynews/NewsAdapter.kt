...
class NewsAdapter(private val onClick: (String) -> Unit):ListAdapter<NewsModel,NewsAdapter.ViewHolder>(diffUtil){ //class NewsAdapter:ListAdapter<NewsModel,ViewHolder>(diffUtil)
